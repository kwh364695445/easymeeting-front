/*
 * @Date: 2026-04-13 21:50:20
 * @LastEditTime: 2026-04-13 21:50:51
 * @FilePath: \MyMeeting-Client-maind:\前端练习\vue3\easymeeting-front\src\renderer\src\utils\Api.js
 * @Description: 所有的请求接口
 */
const Api = {
    ...
    updatePassword: "/account/updatePassword",//修改用户密码
    ...
    uploadFile: "/api/chat/uploadFile",//上传聊天资源
    ...
    sendMessage: "/chat/sendMessage",//发送聊天消息，
    ...
    loadContactApplyDealWithCount: "/userContact/loadContactApplyDealWithCount",//获取未处理的申请数
    ...
    joinReserveMeeting: "/meeting/joinReserveMeeting",//加入预约会议
    ...
    loadMeetingAdmin: "/admin/loadMeetingAdmin",//获取会议
    finishMeetingAdmin: "/admin/finishMeetingAdmin",//管理员结束会议
    checkVersion: "/update/checkVersion",//更新检测
    downloadUpdate: "/api/update/downloadUpdate",//下载史新
